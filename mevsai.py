"""IMPORTANT. the better the generation is the better it will prefrom.
also in the 'run neat config' method change the name of the file to the most up to date chechpoint.
to do this simply just change the number after the dash. USE THE HIGHEST NUMBER POSSIBLE FOR BEST AI"""
...
def run_neat(config):
    ...
    p.add_reporter(neat.Checkpointer(17))
