"""Use this code to run the ai againts other ai. This will create new generations and store them.
if you would like to play against the AI use the 'mevsai' program.
"""
